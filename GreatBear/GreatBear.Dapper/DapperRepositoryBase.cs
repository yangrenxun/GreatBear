...
{
    /// <inheritdoc />
    public class DapperRepositoryBase<TEntity, TPrimaryKey> : AbsRepositoryBase<TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
    {
        private readonly IDapperProvider _databaseProvider;

        /// <inheritdoc />
        public DapperRepositoryBase(IDapperProvider dbConnectionProvider)
        {
